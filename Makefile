...
################################################################################
# \copyright
# $ Copyright YEAR Cypress Semiconductor Apache2 $
...
APPNAME=mtb-example-btstack-freertos-extadv-beacon
...
# added to the build
#
COMPONENTS=FREERTOS WICED_BLE FIRMWARE-TX10 BTSS-IPC beacon_lib
